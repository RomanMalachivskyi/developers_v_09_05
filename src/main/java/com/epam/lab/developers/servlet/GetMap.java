...
//		
//		MapDAO mapObject = new MapDAO(); 		//створення обєкту, який містить координати обєктів та посилання на їх картинки
//		
//		GameMap map = null;
//		try {
...
//		}
		...
		if (null != user) {
			...
			String message = request.getParameter("message"); //отримання параметру, який повідомляє чи цей запит на отримання даних про текстури

...
public class Register extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (p == 3) {
			...
			new UserDAO().insert(new User(name, MD5Generate(password), eMail, photo));
	...
	/**
	 * @param pass - пароль у стрічковому форматі
	 * @throws NoSuchAlgorithmException не існуючий алгоритм
	...
	/**
	 * @param eMail - адреса пошти
	 * @return true - адреса правильна;
	 * false - адреса не правильна
	 * */
